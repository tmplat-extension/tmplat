...
See [TESTING.md](TESTING.md) for how the tests are organized and what is expected of new tests, and
[RELEASING.md](RELEASING.md) for how a version is tagged, translated and published.
...
Remember to add your details to the list of [AUTHORS.md](AUTHORS.md) if you want your contribution to be recognized by
others.
