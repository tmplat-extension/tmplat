...
3. Ensure that you have all the dependencies by entering `pnpm install`
4. To compile a developer runnable version enter `pnpm build:dev`
   - Outputs to the `dist/temp` directory
5. To compile a production-optimized runnable version enter `pnpm build:prod`
   - Outputs to the `dist/temp` directory
