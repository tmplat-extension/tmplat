...
const renderTemplateListItem = ({
  ...
  disabled = false,
  errorDetailFallbacks = { messageKey: 'app_error_unknown_message' as const },
  messageService = {
  ...
  renderUi(
    ...
    { contexts: { errorDetailFallbacks, tabService, templateService } },
  );
...
describe('TemplateListItem', () => {
  ...
  it('shows and dismisses a localized error when template execution fails', async () => {
    ...
    expect(dismiss.parentElement).toHaveAttribute('title', 'app_error_unknown_message');
