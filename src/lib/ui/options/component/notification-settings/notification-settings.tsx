...
export function NotificationSettings({ onChange, settings }: SettingsPageProps<SettingsNotification>) {
  ...
  return (
    <>
      ...
      <SettingsSection
        title={intl.getMessage('settings_notification_changelog_title')}
        description={intl.getMessage('settings_notification_changelog_description')}
      >
        <SettingsSwitch
          ...
          label={intl.getMessage('settings_notification_changelog_enabled_label')}
        />
        <TextField
          select
          fullWidth
          label={intl.getMessage('settings_notification_changelog_scope_label')}
