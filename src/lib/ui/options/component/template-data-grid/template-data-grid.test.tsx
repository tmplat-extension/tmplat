...
describe('TemplateDataGrid', () => {
  ...
  describe('bulk actions', () => {
    ...
    it('moves the selected templates to the top and bottom', async () => {
      ...
      await user.click(screen.getByRole('menuitem', { name: 'template_grid_move_top_option' }));
      ...
      await user.click(screen.getByRole('menuitem', { name: 'template_grid_move_bottom_option' }));
    ...
    it('does not delete when the confirmation is cancelled', async () => {
      ...
      await user.click(within(dialog).getByRole('button', { name: 'confirm_dialog_cancel_button' }));
  ...
  describe('row actions', () => {
    ...
    it.each([
      ...
      ['template_grid_move_up_option', 0],
    ...
    it.each(['template_grid_move_to_bottom_option', 'template_grid_move_down_option'])(
    ...
    it.each([
      ['template_grid_move_to_top_option', 0],
      ['template_grid_move_up_option', 0],
      ['template_grid_move_down_option', 2],
