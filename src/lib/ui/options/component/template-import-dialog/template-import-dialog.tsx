...
import { type TemplateTransfer } from 'extension/template/template-transfer.schema';
...
export function TemplateImportDialog({ onClose, onImported, open }: TemplateImportDialogProps) {
  ...
  const [parsedTemplates, setParsedTemplates] = useState<TemplateTransfer[]>();
  ...
  const handleParse = useCallback(
    ...
    [getErrorMessage, templateService],
  );
  ...
  }, [getErrorMessage, onClose, onImported, parsedTemplates, selectedIndexes, templateService]);
  ...
  const canRead = !!source.trim() && !readingFile;
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      ...
      <DialogActions>
        ...
        {view === 'source' ? (
          <>
            <Button variant="outlined" component="label" loading={readingFile} disabled={readingFile}>
          ...
          <>
            ...
            <Button variant="contained" loading={importing} disabled={!canImport} onClick={handleImport}>
