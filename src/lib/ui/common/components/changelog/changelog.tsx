...
import { type Changelog as ChangelogModel, type ChangelogEntry } from 'extension/common/changelog/changelog.schema';
...
type ChangelogCategory = {
  readonly key: Exclude<keyof ChangelogEntry, 'date' | 'unreleased' | 'version'>;
