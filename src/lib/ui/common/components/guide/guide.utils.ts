...
import {
  ...
  type TemplateContextEntryDefinitionCategories,
  type TemplateContextEntryDefinitionCategory,
  type TemplateContextEntryDefinitionCollectionCategory,
  type TemplateContextEntryDefinitionCollectionProperty,
  type TemplateContextEntryDefinitionOperationCategory,
      ...
      return [
        {
          ...
          aliases: [...(definition.aliases ?? [])].toSorted((a, b) => a.localeCompare(b)),
...
function flattenProperties(
  ...
  for (const [key, property] of Object.entries(properties)) {
    ...
    if ('properties' in property) {
      ...
      entries.push(...flattenProperties(dataTypeLabels, property.properties, propertyPath, definition));
    } else {
      entries.push({
        added: definition.added,
        aliases: [],
