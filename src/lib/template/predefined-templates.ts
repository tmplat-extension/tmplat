...
import { type TemplateDataTemplatePredefined } from 'extension/template/data/template-data.schema';
 ...
 */
export const toPredefinedTemplateData = (predefinedTemplate: PredefinedTemplate): TemplateDataTemplatePredefined => ({
