 ...
 * modest templates. Moving them here trades cross-device sync for a 10 MB budget and a per-template size limit; see
 * MIGRATION-GAPS.md §1.7 for the full rationale and §5 for the accepted loss of template syncing.
 */
@injectable()
