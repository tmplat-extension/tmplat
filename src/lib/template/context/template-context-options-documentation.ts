...
export const optionsDocumentation: TemplateContextOptionsDocumentation = {
  notifications: {
    ...
    properties: {
      changelog: {
        descriptionKey: 'context_options_notifications_changelog_description',
        properties: {
          enabled: {
            dataType: TemplateContextDataType.Boolean,
            descriptionKey: 'context_options_notifications_changelog_enabled_description',
          },
          scope: {
            dataType: TemplateContextDataType.String,
            descriptionKey: 'context_options_notifications_changelog_scope_description',
    ...
    properties: {
      ...
      contextMenu: {
        ...
        properties: {
          ...
          templateId: {
            dataType: TemplateContextDataType.String,
            descriptionKey: 'context_options_templates_context_menu_template_id_description',
          },
        },
      },
      links: {
