...
import { MarkdownService } from 'extension/common/markdown/markdown.service';
...
import { GetTabContentMessageReply } from 'extension/tab/message/get-tab-content-message.model';
...
export class TemplateContextManager {
  ...
  getTabContent(
    ...
    queryAll: boolean,
  ): Promise<GetTabContentMessageReply['output']> {
    return this.computeCacheIfAbsent(
