...
import { type TemplateContextCategoryLink } from 'extension/template/context/template-context-category-link';
import { type TemplateContextCategory } from 'extension/template/context/template-context-category.enum';
import { type TemplateContextDataType } from 'extension/template/context/template-context-data-type.enum';
import { type TemplateContextFeature } from 'extension/template/context/template-context-feature.enum';
