...
import { authority } from 'extension/template/context/entry/authority';
...
import { coords } from 'extension/template/context/entry/coords';
...
import { markdownInline } from 'extension/template/context/entry/deprecated/markdown-inline';
import { menu } from 'extension/template/context/entry/deprecated/menu';
import { menuOptions } from 'extension/template/context/entry/deprecated/menu-options';
import { menuPaste } from 'extension/template/context/entry/deprecated/menu-paste';
import { notificationDuration } from 'extension/template/context/entry/deprecated/notification-duration';
import { notifications } from 'extension/template/context/entry/deprecated/notifications';
import { originalSource } from 'extension/template/context/entry/deprecated/original-source';
...
import { popular } from 'extension/template/context/entry/deprecated/popular';
import { query } from 'extension/template/context/entry/deprecated/query';
import { selectionLinks } from 'extension/template/context/entry/deprecated/selection-links';
import { short } from 'extension/template/context/entry/deprecated/short';
import { shortcuts } from 'extension/template/context/entry/deprecated/shortcuts';
import { shortcutsPaste } from 'extension/template/context/entry/deprecated/shortcuts-paste';
import { toolbarClose } from 'extension/template/context/entry/deprecated/toolbar-close';
import { toolbarFeature } from 'extension/template/context/entry/deprecated/toolbar-feature';
import { toolbarFeatureDetails } from 'extension/template/context/entry/deprecated/toolbar-feature-details';
import { toolbarFeatureName } from 'extension/template/context/entry/deprecated/toolbar-feature-name';
import { toolbarKey } from 'extension/template/context/entry/deprecated/toolbar-key';
import { toolbarOptions } from 'extension/template/context/entry/deprecated/toolbar-options';
import { toolbarPopup } from 'extension/template/context/entry/deprecated/toolbar-popup';
import { toolbarStyle } from 'extension/template/context/entry/deprecated/toolbar-style';
...
import { yourls } from 'extension/template/context/entry/deprecated/yourls';
import { yourlsAuthentication } from 'extension/template/context/entry/deprecated/yourls-authentication';
import { yourlsPassword } from 'extension/template/context/entry/deprecated/yourls-password';
import { yourlsSignature } from 'extension/template/context/entry/deprecated/yourls-signature';
import { yourlsUrl } from 'extension/template/context/entry/deprecated/yourls-url';
import { yourlsUsername } from 'extension/template/context/entry/deprecated/yourls-username';
...
import { linkHtml } from 'extension/template/context/entry/link-html';
import { linkMarkdown } from 'extension/template/context/entry/link-markdown';
import { linkText } from 'extension/template/context/entry/link-text';
import { links } from 'extension/template/context/entry/links';
import { localStorage } from 'extension/template/context/entry/local-storage';
import { locale } from 'extension/template/context/entry/locale';
...
import { markdown } from 'extension/template/context/entry/markdown';
import { meta } from 'extension/template/context/entry/meta';
import { offline } from 'extension/template/context/entry/offline';
import { options } from 'extension/template/context/entry/options';
import { origin } from 'extension/template/context/entry/origin';
import { os } from 'extension/template/context/entry/os';
import { password } from 'extension/template/context/entry/password';
import { path } from 'extension/template/context/entry/path';
import { plugins } from 'extension/template/context/entry/plugins';
...
import { referrer } from 'extension/template/context/entry/referrer';
...
import { screenHeight } from 'extension/template/context/entry/screen-height';
import { screenWidth } from 'extension/template/context/entry/screen-width';
import { scripts } from 'extension/template/context/entry/scripts';
...
import { select } from 'extension/template/context/entry/select';
import { selectAll } from 'extension/template/context/entry/select-all';
import { selectAllHtml } from 'extension/template/context/entry/select-all-html';
import { selectAllMarkdown } from 'extension/template/context/entry/select-all-markdown';
import { selectHtml } from 'extension/template/context/entry/select-html';
import { selectMarkdown } from 'extension/template/context/entry/select-markdown';
import { selectedImages } from 'extension/template/context/entry/selected-images';
import { selectedLinks } from 'extension/template/context/entry/selected-links';
import { selection } from 'extension/template/context/entry/selection';
import { selectionHtml } from 'extension/template/context/entry/selection-html';
import { selectionMarkdown } from 'extension/template/context/entry/selection-markdown';
import { sessionStorage } from 'extension/template/context/entry/session-storage';
...
import { source } from 'extension/template/context/entry/source';
import { startCase } from 'extension/template/context/entry/start-case';
import { styleSheets } from 'extension/template/context/entry/style-sheets';
import { tabs } from 'extension/template/context/entry/tabs';
import { template } from 'extension/template/context/entry/template';
...
import { text } from 'extension/template/context/entry/text';
...
import { user } from 'extension/template/context/entry/user';
import { userInfo } from 'extension/template/context/entry/user-info';
...
import { xpath } from 'extension/template/context/entry/xpath';
import { xpathAll } from 'extension/template/context/entry/xpath-all';
import { xpathAllHtml } from 'extension/template/context/entry/xpath-all-html';
import { xpathAllMarkdown } from 'extension/template/context/entry/xpath-all-markdown';
import { xpathHtml } from 'extension/template/context/entry/xpath-html';
import { xpathMarkdown } from 'extension/template/context/entry/xpath-markdown';
...
export const templateContextEntriesDefinitions: TemplateContextEntryDefinition[] = [
  ...
  selectMarkdown,
  selectedImages,
  ...defineWithAliases(selectedLinks, [selectionLinks]),
  selection,
  selectionHtml,
  selectionMarkdown,
  sessionStorage,
  ...
  toolbarClose,
  toolbarFeature,
  ...defineWithAliases(toolbarKey, [toolbarFeatureName]),
  toolbarOptions,
  toolbarPopup,
  ...defineWithAliases(toolbarStyle, [toolbarFeatureDetails]),
  trim,
  ...
  upper,
  upperCase,
  ...defineWithAliases(url, [originalUrl, originalSource]),
  user,
  userInfo,
  uuid,
  version,
