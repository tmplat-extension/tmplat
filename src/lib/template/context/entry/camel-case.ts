import { camelCase as _camelCase } from 'es-toolkit';
...
export const camelCase: TemplateContextEntryDefinition = {
  ...
  categories: {
    [TemplateContextCategory.Operation]: {
      descriptionKey: 'context_camel_case_operation_description',
      inputDataType: TemplateContextDataType.String,
      outputDataType: TemplateContextDataType.String,
      links: [WikipediaCamelCaseLink],
    },
  },
  render: createContentRenderer((content) => _camelCase(content)),
};
