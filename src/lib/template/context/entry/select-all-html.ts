...
/** The HTML content of every element matching the CSS selector provided. */
export const selectAllHtml: TemplateContextEntryDefinition = {
  name: TemplateContextName.SelectAllHtml,
  added: ExtensionVersion.V2_0_0,
  categories: {
    [TemplateContextCategory.Collection]: {
      descriptionKey: 'context_select_all_html_collection_description',
  ...
  render: createSelectOrXpathAllRenderer(GetTabContentMessageExpressionType.Selector, GetTabContentMessageFormat.Html),
};
