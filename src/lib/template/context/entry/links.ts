...
export const links: TemplateContextEntryDefinition = {
  name: TemplateContextName.Links,
  added: '2.0.0',
  categories: {
    [TemplateContextCategory.Collection]: {
      descriptionKey: 'context_links_collection_description',
  ...
  render: createTabContextRenderer(({ links: tabLinks }) => tabLinks),
};
