...
/** The text content of the first element matching the CSS selector provided. */
export const select: TemplateContextEntryDefinition = {
  name: TemplateContextName.Select,
  added: ExtensionVersion.V2_0_0,
  categories: {
    [TemplateContextCategory.Operation]: {
      descriptionKey: 'context_select_operation_description',
      inputDataType: TemplateContextDataType.String,
      outputDataType: TemplateContextDataType.String,
    },
  },
  features: [TemplateContextFeature.TabContext],
  render: createSelectOrXpathRenderer(GetTabContentMessageExpressionType.Selector, GetTabContentMessageFormat.Text),
};
