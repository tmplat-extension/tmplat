...
/** The Markdown conversion of the HTML content of every element matching the CSS selector provided. */
export const selectAllMarkdown: TemplateContextEntryDefinition = {
  name: TemplateContextName.SelectAllMarkdown,
  added: ExtensionVersion.V2_0_0,
  categories: {
    [TemplateContextCategory.Collection]: {
      descriptionKey: 'context_select_all_markdown_collection_description',
  ...
  render: createSelectOrXpathAllMarkdownRenderer(GetTabContentMessageExpressionType.Selector),
};
