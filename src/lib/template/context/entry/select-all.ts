...
/** The text content of every element matching the CSS selector provided. */
export const selectAll: TemplateContextEntryDefinition = {
  name: TemplateContextName.SelectAll,
  added: ExtensionVersion.V2_0_0,
  categories: {
    [TemplateContextCategory.Collection]: {
      descriptionKey: 'context_select_all_collection_description',
  ...
  render: createSelectOrXpathAllRenderer(GetTabContentMessageExpressionType.Selector, GetTabContentMessageFormat.Text),
};
