...
export const scripts: TemplateContextEntryDefinition = {
  name: TemplateContextName.Scripts,
  added: '2.0.0',
  categories: {
    [TemplateContextCategory.Collection]: {
      descriptionKey: 'context_scripts_collection_description',
  ...
  render: createTabContextRenderer(({ scripts: tabScripts }) => tabScripts),
};
