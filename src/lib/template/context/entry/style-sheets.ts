...
export const styleSheets: TemplateContextEntryDefinition = {
  name: TemplateContextName.StyleSheets,
  added: '2.0.0',
  categories: {
    [TemplateContextCategory.Collection]: {
      descriptionKey: 'context_style_sheets_collection_description',
  ...
  render: createTabContextRenderer(({ styleSheets: tabStyleSheets }) => tabStyleSheets),
};
