...
export const java: TemplateContextEntryDefinition = {
  name: TemplateContextName.Java,
  added: ExtensionVersion.V1_0_0,
  deprecated: ExtensionVersion.V2_0_0,
  categories: {
    [TemplateContextCategory.Standard]: {
      descriptionKey: IntlMessageKey.ContextDeprecatedJavaStandardDescription,
      dataType: TemplateContextDataType.Boolean,
    },
  },
  features: [TemplateContextFeature.TabContext],
  render: createTabContextRenderer(({ javaEnabled }) => javaEnabled),
};
