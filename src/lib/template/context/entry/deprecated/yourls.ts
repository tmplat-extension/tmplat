...
export const yourls: TemplateContextEntryDefinition = {
  name: TemplateContextName.Yourls,
  added: ExtensionVersion.V1_0_0,
  deprecated: ExtensionVersion.V2_0_0,
  categories: {
    [TemplateContextCategory.Standard]: {
      descriptionKey: 'context_deprecated_yourls_standard_description',
      dataType: TemplateContextDataType.Boolean,
      isDeprecatedOption: true,
    },
  },
  render: createOptionRenderer(({ urlShorteners }) => urlShorteners.provider === UrlShortenerProviderName.Yourls),
};
