...
export const selectedLinks: TemplateContextEntryDefinition = {
  name: TemplateContextName.SelectedLinks,
  added: ExtensionVersion.V2_0_0,
  categories: {
    [TemplateContextCategory.Collection]: {
      descriptionKey: 'context_selected_links_collection_description',
  ...
  render: createTabContextRenderer(({ selection }) => selection.links),
};
