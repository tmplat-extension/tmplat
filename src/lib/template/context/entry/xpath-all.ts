...
/** The text content of every result of the XPath expression provided. */
export const xpathAll: TemplateContextEntryDefinition = {
  name: TemplateContextName.XpathAll,
  added: ExtensionVersion.V2_0_0,
  categories: {
    [TemplateContextCategory.Collection]: {
      descriptionKey: 'context_xpath_all_collection_description',
  ...
  render: createSelectOrXpathAllRenderer(GetTabContentMessageExpressionType.Xpath, GetTabContentMessageFormat.Text),
};
