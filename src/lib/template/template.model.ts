import {
  type TemplatePredefined as TemplatePredefinedData,
  type TemplateUserDefined as TemplateUserDefinedData,
} from 'extension/template/data/template-data.schema';
import { type PredefinedTemplateProperties } from 'extension/template/predefined-templates';
...
export type TemplatePredefined = Readonly<TemplatePredefinedData> & Readonly<PredefinedTemplateProperties>;

export type TemplateUserDefined = Readonly<TemplateUserDefinedData>;
