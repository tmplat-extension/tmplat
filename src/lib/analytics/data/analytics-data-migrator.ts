...
import { LegacyAnalyticsDataSchema } from 'extension/analytics/data/legacy-analytics-data.schema';
  ...
  protected getSteps(builder: DataMigrationStepBuilder): DataMigrationStep[] {
    return [
      builder.createSimpleStepForTransfer(
        ...
        { key: 'analytics', schema: LegacyAnalyticsDataSchema, storage: 'local' },
        this.repository,
        (data, legacyData) => {
