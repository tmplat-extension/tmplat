...
export type RenderUiContexts = {
  ...
  dataMigrationManager?: Partial<DataMigrationManager>;
  errorDetailFallbacks?: Partial<ErrorDetailFallback>;
...
export const renderUi = (ui: ReactElement, { contexts, ...options }: RenderUiOptions = {}): RenderResult => {
  const {
    ...
    errorDetailFallbacks = { messageKey: 'error_snackbar_unknown_message' },
            ...
            <SettingsContext.Provider value={settingsService as SettingsService}>
              <TemplatesContext.Provider value={templateService as TemplateService}>
                <MessagesContext.Provider value={messageService as MessageService}>
                  <DataMigrationsContext.Provider value={dataMigrationManager as DataMigrationManager}>
                    <ErrorDetailContext.Provider value={errorDetailFallbacks}>{children}</ErrorDetailContext.Provider>
