...
import { type UrlShortenerSpooMeProviderConfig } from 'extension/url-shortener/data/url-shortener-data.schema';
 ...
 */
@injectable()
export class SpooMeUrlShortenerProvider extends AbstractUrlShortenerProvider<UrlShortenerSpooMeProviderConfig> {
