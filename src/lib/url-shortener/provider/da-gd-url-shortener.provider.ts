...
import { type UrlShortenerDaGdProviderConfig } from 'extension/url-shortener/data/url-shortener-data.schema';
 ...
 */
@injectable()
export class DaGdUrlShortenerProvider extends AbstractUrlShortenerProvider<UrlShortenerDaGdProviderConfig> {
