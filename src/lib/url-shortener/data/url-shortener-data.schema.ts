...
export const UrlShortenerBitlyProviderConfigSchema = z.object({}).meta({ id: 'UrlShortenerBitlyProviderConfig' });

export type UrlShortenerBitlyProviderConfig = z.infer<typeof UrlShortenerBitlyProviderConfigSchema>;
...
export const UrlShortenerProviderConfigSchema = z
  .union([
    UrlShortenerBitlyProviderConfigSchema,
...
export const UrlShortenerProviderConfigsSchema = z
  .object({
    [UrlShortenerProviderName.Bitly]: UrlShortenerBitlyProviderConfigSchema,
