...
export class UrlShortenerDataMigrator extends AbstractDataMigrator {
  ...
  protected getSteps(builder: DataMigrationStepBuilder): DataMigrationStep[] {
    return [
      ...
      builder.createSimpleStepForRemoval('1.2.9', 'data_namespace_url_shortener_migration_step_1', {
        keys: ['bitly'],
        storage: 'local',
      }),
      ...
      builder.createSimpleStepForRemoval('1.2.9', 'data_namespace_url_shortener_migration_step_3', {
        keys: ['googl'],
        storage: 'local',
      }),
      /*
       ...
       * indefinitely.
       */
      builder.createSimpleStepForRemoval('1.2.9', 'data_namespace_url_shortener_migration_step_4', {
